    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apptStatus', models.CharField(choices=[('pending', 'Pending'), ('approved', 'Approved'), ('rejected', 'Rejected')], default='pending', max_length=8)),
                ('apptRejectionReason', models.CharField(default='-', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Attendance',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(default=datetime.datetime(2019, 3, 9, 18, 34, 23, 185707, tzinfo=utc))),
            ],
        ),
        migrations.CreateModel(
            name='Class',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commentDate', models.DateField(default=datetime.datetime(2019, 3, 9, 18, 34, 23, 184832, tzinfo=utc))),
                ('commentTime', models.TimeField(default=datetime.datetime(2019, 3, 9, 18, 34, 23, 184856, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classOf', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.Class')),
