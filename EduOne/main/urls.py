...
###==================================Teachers Functions=========================================================== 
    ...
    path('grades/<str:id>/<int:report_card_page_id>/add/', views.grades_add, name='grades-add' ),
    path('grades/<str:id>/<int:report_card_page_id>/delete/<int:pk>', Grades_Delete_Form.as_view(template_name = "student_settings/grades_delete.html"), name='grades-delete' ), 
